...
class ItemServiceImplTest {
    ...
    void create_conflictWhenSkuExists() {
        var rq = new CreateItemRQ("SKU-1","T","D","ARS",
                new BigDecimal("10.00"), 1, "SELLER","NEW", false, List.of(), java.util.Map.of());
    ...
    void create_ok() {
        var rq = new CreateItemRQ("SKU-1","T","D","ARS",
                new BigDecimal("10.00"), 1, "SELLER","NEW", true, List.of("A"), java.util.Map.of("k","v"));
